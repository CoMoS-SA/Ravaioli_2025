...
#include "auxiliary/read_mh_inputs.h"       // Functions to read values from inputs and generate unordered_maps for households classes
#include "auxiliary/umap_functions.h"       // Functions to perform operations on unordered_map class
